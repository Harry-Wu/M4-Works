...
void led_init(void)
{
	...
	GPIOF->MODER &=~((0X3<<12)| (0X3<<18)|(0X3<<20));
	GPIOF->MODER |=((0X1<<12)| (0X1<<18)|(0X1<<20)) ;  //普通功能输出
	GPIOF->OTYPER &=~((0X01<<6)| (0X01<<9)| (0X01<<10));//推挽输出
	GPIOF->OSPEEDR &=~((0X3<<12)| (0X3<<18)|(0X3<<20));  //输出速度2M
	GPIOF->PUPDR &=~((0X3<<12)| (0X3<<18)|(0X3<<20));    //无上/下拉
